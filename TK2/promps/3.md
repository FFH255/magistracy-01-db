Выполни одну команду INSERT для таблицы properties_description, которая заполнит таблицу данными из таблицы properties, учитывая:
- Если собственник (landlord) не указан (null), указать значение "Нет данных"
- Если тип объекта недвижимости «Дом», для номера квартиры указать значение «Нет»
- Информация о жилой площади отсутствует
